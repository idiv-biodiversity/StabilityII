...
modList2=list(
  ...
  lme(TS_detrend_lg2~GrossAsynchrony_s+PCAdim1_4trts+lg2SppN+eMNTD+FDis4+sdAridity+lg2_mArid,random=~1+lg2SppN|Site, control=cc,data=stab_444)
)
...
mf_ts_emntd$ResponseVars<-c("eMNTD","FDis4","Asynchrony","Temp_Stability_Detrend")
mf_ts_emntd$PredVars<-c("lg2SppN","lg2SppN","lg2SppN,eMNTD,FDis4, lg2_mArid, Arid_sd","eMNTD, FDis4,Asynchrony,lg2SppN,lg2_mArid, mf_ts_emntd")
mf_ts_emntd$ModClass<-"FDis_eMNTD"

# write model results
write.table(ts_emntd2,"detrendTS_emntd_fdis_sem_coefs_SIMPLE.csv",sep=",",row.names=F)
write.table(mf_ts_emntd,"detrendTS_emntd_fdis_model_fits_SIMPLE.csv",sep=",",row.names=F)
write.table(emntdfdis.fit,"detrendTS_emntd_fdis_semfit_SIMPLE.csv",sep=",",row.names=F)
...
modList22=list(
  ...
  lme(TS_detrend_lg2~GrossAsynchrony_s+PCAdim1_4trts+lg2SppN+eMNTD+FRic4+sdAridity+lg2_mArid,random=~1+lg2SppN|Site, control=cc,data=stab_444)
)
...
mf_ts_emntd$ResponseVars<-c("eMNTD","FRic4","Asynchrony","Temp_Stability_Detrend")
...
write.table(ts_emntd2,"detrendTS_TS_emntd_fric_sem_coefs_SIMPLE.csv",sep=",",row.names=F)
write.table(mf_ts_emntd,"detrendTS_TS_emntd_fric_model_fits_SIMPLE.csv",sep=",",row.names=F)
write.table(emntdfric.fit,"detrendTS_TS_emntd_fric_semfit_SIMPLE.csv",sep=",",row.names=F)
...
modList3=list(
  ...
  lme(TS_detrend_lg2~GrossAsynchrony_s+PCAdim1_4trts+lg2SppN+FDis4+eMPD+sdAridity+lg2_mArid,random=~1+lg2SppN|Site, control=cc,data=stab_444)
)
...
mf_ts_empd$ResponseVars<-c("eMPD","FDis4","Asynchrony","Temp_Stability_Detrend")
...
# write out model results
write.table(ts_empd2,"detrendTS_TS_empd_fdis_sem_coefs_SIMPLE.csv",sep=",",row.names=F)
write.table(mf_ts_empd,"detrendTS_TS_empd_fdis_model_fits_SIMPLE.csv",sep=",",row.names=F)
write.table(empdfdis.fit,"detrendTS_TS_empd_fdis_semfit_SIMPLE.csv",sep=",",row.names=F)
...
modList33=list(
  ...
  lme(TS_detrend_lg2~GrossAsynchrony_s+PCAdim1_4trts+lg2SppN+FRic4+eMPD+sdAridity+lg2_mArid,random=~1+lg2SppN|Site, control=cc,data=stab_444)
)
...
mf_ts_smpd$ResponseVars<-c("eMPD","FRic4","Asynchrony","Temp_Stability_Detrend")
...
# write out model results
write.table(ts_smpd2,"detrendTS_TS_empd_fric_sem_coefs_SIMPLE.csv",sep=",",row.names=F)
write.table(mf_ts_smpd,"detrendTS_TS_empd_fric_model_fits_SIMPLE.csv",sep=",",row.names=F)
write.table(smpdfdis.fit,"detrendTS_TS_empd_fric_semfit_SIMPLE.csv",sep=",",row.names=F)