...
modList2=list(
  ...
  lme(Plot_Biomasssd~GrossAsynchrony_s+PCAdim1_4trts+lg2SppN+eMNTD+FDis4+sdAridity, random=~1+lg2SppN|Site,control=cc, data=stab_444),
...
write.table(ts_emntd2,"TS_emntd_fdis_sem_coefs_Extended.csv",sep=",",row.names=F)
write.table(mf_ts_emntd,"TS_emntd_fdis_model_fits_Extended.csv",sep=",",row.names=F)
write.table(emntdfdis.fit,"TS_emntd_fdis_semfit_Extended.csv",sep=",",row.names=F)
...
modList22=list(
  ...
  lme(Plot_Biomasssd~GrossAsynchrony_s+PCAdim1_4trts+lg2SppN+eMNTD+FRic4+sdAridity, random=~1+lg2SppN|Site,control=cc, data=stab_444),
...
# write out model results
write.table(ts_emntd2,"TS_emntd_fric_sem_coefs_Extended.csv",sep=",",row.names=F)
write.table(mf_ts_emntd,"TS_emntd_fric_model_fits_Extended.csv",sep=",",row.names=F)
write.table(emntdfric.fit,"TS_emntd_fric_semfit_Extended.csv",sep=",",row.names=F)
...
modList3=list(
  ...
  lme(Plot_Biomasssd~GrossAsynchrony_s+PCAdim1_4trts+lg2SppN+eMPD+FDis4+sdAridity, random=~1+lg2SppN|Site,control=cc, data=stab_444),
...
# write out model results
write.table(ts_empd2,"TS_empd_fdis_sem_coefs_Extended.csv",sep=",",row.names=F)
write.table(mf_ts_empd,"TS_empd_fdis_modelfits_Extended.csv",sep=",",row.names=F)
write.table(empdfdis.fit,"TS_empd_fdis_semfits_Extended.csv",sep=",",row.names=F)
...
modList44=list(
  ...
  lme(Plot_Biomasssd~GrossAsynchrony_s+PCAdim1_4trts+lg2SppN+eMPD+FRic4+sdAridity, random=~1+lg2SppN|Site,control=cc, data=stab_444),
...
# write out model results
write.table(ts_empd2,"TS_empd_fric_sem_coefs_Extended.csv",sep=",",row.names=F)
write.table(mf_ts_empd2,"TS_empd_fric_model_fits_Extended.csv",sep=",",row.names=F)
write.table(empdfric.fit,"TS_empd_fric_semfit_Extended.csv",sep=",",row.names=F)