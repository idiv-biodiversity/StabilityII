...
sem.fit(Rst_Wet_ModList,rs_122,corr.errors=c("Yn_eMNTD~~Yn_FDis4","Yn_eMNTD ~~ Yn_PCAcwm4trts"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))
...
wet_rst_fdis_emntd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,FDis4,eMNTD,lg2SppN")
...
write.table(wet_rst_fdis_emntd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_emntd_fdis_sem_coefs_NEW.csv",sep=",",row.names=F)
write.table(wet_rst_fdis_emntd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_emntd_fdis_model_fits_NEW.csv",sep=",",row.names=F)
...
Rst_Wet_ModList=list(
  ...
  lme(Yn_FDis4~lg2SppN,random=~1+lg2SppN|Site/PlotUnique2, correlation=x1,control=bb,data=rs_122),
  lme(lg2Rst12~Yn_PCAcwm4trts+lg2SppN+Yn_FDis4+Yn_eMPD,random=~1+lg2SppN|Site/PlotUnique2, correlation=x1,control=bb,data=rs_122)
...
sem.fit(Rst_Wet_ModList,rs_122,corr.errors=c("Yn_eMPD~~Yn_FDis4","Yn_eMPD ~~ Yn_PCAcwm4trts"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))
...
wet_rst_fdis_empd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,FDis4,lg2SppN")
...
write.table(wet_rst_fdis_empd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_empd_fdis_sem_coefs_NEW.csv",sep=",",row.names=F)
write.table(wet_rst_fdis_empd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_empd_fdis_model_fits_NEW.csv",sep=",",row.names=F)
...
Rst_Wet_ModList=list(
  ...
  lme(Yn_FDis4~lg2SppN,random=~1+lg2SppN|Site/PlotUnique2, correlation=x1,control=bb,data=rs_122),
  lme(lg2Rst12~Yn_PCAcwm4trts+lg2SppN+Yn_ePSE+Yn_FDis4,random=~1+lg2SppN|Site/PlotUnique2, correlation=x1,control=bb,data=rs_122)
...
sem.fit(Rst_Wet_ModList,rs_122,corr.errors=c("Yn_ePSE~~Yn_FDis4","Yn_ePSE ~~ Yn_PCAcwm4trts"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))
...
write.table(wet_rst_fdis_epse_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_epse_fdis_sem_coefs_NEW.csv",sep=",",row.names=F)
write.table(wet_rst_fdis_epse_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_epse_fdis_model_fits_NEW.csv",sep=",",row.names=F)
...
wet_rst_fric_emntd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,FRic4,lg2SppN")
wet_rst_fric_emntd_modfit$Climate_Bin<-"Wet"

sem.plot(Rst_Dry_ModList,rs_122,show.nonsig = FALSE,scaling=20)

resids.df1<-partial.resid(lg2Rst12~lg2SppN,Rst_Wet_ModList,data=rs_122,
                          model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))
...
wet_rst_fric_empd_pc$Climate_Bin<-"Wet"

wet_rst_fric_empd_modfit<-sem.model.fits(Rst_Wet_ModList)
wet_rst_fric_empd_modfit$ResponseVars<-c("Yn_eMPD","FRic4","Resistance")
wet_rst_fric_empd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,Yn_eMPD,lg2SppN")
wet_rst_fric_empd_modfit$Climate_Bin<-"Wet"
...
write.table(wet_rst_fric_empd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_empd_fric_sem_coefs_V2.csv",sep=",",row.names=F)
write.table(wet_rst_fric_empd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_empd_fric_model_fits_V2.csv",sep=",",row.names=F)
...
sem.fit(Rst_Wet_ModList,rs_122,corr.errors=c("Yn_ePSE~~Yn_FRic4","Yn_ePSE ~~ Yn_PCAcwm4trts","Yn_FRic4 ~~ Yn_PCAcwm4trts"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))



wet_rst_fric_epse_pc<- sem.coefs(Rst_Wet_ModList,rs_122,standardize="scale")
wet_rst_fric_epse_pc$Climate_Bin<-"Wet"

wet_rst_fric_epse_modfit<-sem.model.fits(Rst_Wet_ModList)
wet_rst_fric_epse_modfit$ResponseVars<-c("Yn_eMPD","FRic4","Resistance")
wet_rst_fric_epse_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,FRic4,lg2SppN")
wet_rst_fric_epse_modfit$Climate_Bin<-"Wet"
