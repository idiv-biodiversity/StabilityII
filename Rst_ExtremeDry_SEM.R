...
exdry_rst_fdis_epse_modfit$ResponseVars<-c("Yn_ePSE","FDis4","Resistance")
exdry_rst_fdis_epse_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,Yn_ePSE,FDis4,lg2SppN")
exdry_rst_fdis_epse_modfit$Climate_Bin<-"Extreme Dry"

sem.plot(Rst_Dry_ModList,rs_12x,show.nonsig = FALSE,scaling=20)
...
sem.coefs(Rst_Dry_ModList,rs_122x,standardize="scale",corr.errors=c("Yn_eMNTD~~Yn_FRic4"))

exdry_rst_fric_emntd_pc<- sem.coefs(Rst_Dry_ModList,rs_122x,standardize="scale")
exdry_rst_fric_emntd_pc$Climate_Bin<-"Extreme Dry"

exdry_rst_fric_emntd_modfit<-sem.model.fits(Rst_Dry_ModList)

exdry_rst_fric_emntd_modfit$ResponseVars<-c("eMNTD","FRic4","Resistance")
exdry_rst_fric_emntd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,eMNTD,FRic4,lg2SppN")
exdry_rst_fric_emntd_modfit$Climate_Bin<-"Extreme Dry"

sem.plot(Rst_Dry_ModList,rs_122,show.nonsig = FALSE,scaling=20)

resids.df1<-partial.resid(lg2Rst12~lg2SppN,Rst_Dry_ModList,data=rs_122x,
                          model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))

write.table(exdry_rst_fric_emntd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXDRY_emntd_fric_sem_coefs.csv",sep=",",row.names=F)
write.table(exdry_rst_fric_emntd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXDRY_emntd_fric_model_fits.csv",sep=",",row.names=F)
