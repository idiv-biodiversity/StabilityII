...
dry<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_DRY_emntd_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
dry1<-filter(dry,response=="lg2Rst12")
dry1$PD_met<-"eMNTD"
dry1$FD_met<-"FDisp"
dry1$X<-NULL

exdry<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXDRY_emntd_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
exdry1<-filter(exdry,response=="lg2Rst12")
exdry1$PD_met<-"eMNTD"
exdry1$FD_met<-"FDisp"
exdry1$X<-NULL

wet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_emntd_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
wet1<-filter(wet,response=="lg2Rst12")
wet1$PD_met<-"eMNTD"
wet1$FD_met<-"FDisp"
wet1$X<-NULL

exwet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXWET_emntd_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
...
paths$predictor<-ifelse(paths$predictor=="Yn_PCAcwm4trts","Fast-Slow (CWM)",paths$predictor)
paths$predictor<-ifelse(paths$predictor=="Yn_eMNTD","Phylogenetic Diversity",paths$predictor)
paths$predictor<-ifelse(paths$predictor=="Yn_FDis4","Functional Diversity",paths$predictor)
...
p1<-ggplot(data=paths,aes(x=Climate_Bin,y=estimate,group=predictor,colour=PathSig))+
  ...
  scale_y_continuous(limits=c(-0.45,.45),breaks=c(-0.4,-.3,-.2,0,-.1,0,.1,.2,.3,0.4))+
...
png(filename="/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/PathCoefficients_Rst_FDisEMNTD.png", 
    type="cairo",
    units="in", 
    width=5 ,
    height=5, 
...
exdry<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXDRY_empd_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
exdry1<-filter(exdry,response=="lg2Rst12")
exdry1$PD_met<-"eMPD"
exdry1$FD_met<-"FDisp"
exdry1$X<-NULL

wet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_empd_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
wet1<-filter(wet,response=="lg2Rst12")
wet1$PD_met<-"eMPD"
wet1$FD_met<-"FDisp"
wet1$X<-NULL

exwet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXWET_empd_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
exwet1<-filter(exwet,response=="lg2Rst12")
exwet1$PD_met<-"eMPD"
exwet1$FD_met<-"FDisp"
exwet1$X<-NULL

paths2<-rbind.data.frame(dry1,exdry1, wet1,exwet1)
...
paths2$predictor<-ifelse(paths2$predictor=="Yn_PCAcwm4trts","Fast-Slow (CWM)",paths2$predictor)
paths2$predictor<-ifelse(paths2$predictor=="Yn_eMPD","Phylogenetic Diversity",paths2$predictor)
paths2$predictor<-ifelse(paths2$predictor=="Yn_FDis4","Functional Diversity",paths2$predictor)
...
png(filename="/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/PathCoefficients_Rst_FDisEMPD.png", 
    type="cairo",
    units="in", 
    width=5 ,
    height=5, 
...
exdry<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXDRY_epse_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
exdry1<-filter(exdry,response=="lg2Rst12")
exdry1$PD_met<-"ePSE"
exdry1$FD_met<-"FDisp"
exdry1$X<-NULL

wet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_epse_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
wet1<-filter(wet,response=="lg2Rst12")
wet1$PD_met<-"ePSE"
wet1$FD_met<-"FDisp"
wet1$X<-NULL

exwet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXWET_epse_fdis_sem_coefs_NEW.csv",sep=",",header=TRUE)
exwet1<-filter(exwet,response=="lg2Rst12")
exwet1$PD_met<-"ePSE"
exwet1$FD_met<-"FDisp"
exwet1$X<-NULL

paths3<-rbind.data.frame(dry1,exdry1, wet1,exwet1)
...
paths3$predictor<-ifelse(paths3$predictor=="Yn_PCAcwm4trts","Fast-Slow (CWM)",paths3$predictor)
paths3$predictor<-ifelse(paths3$predictor=="Yn_ePSE","Phylogenetic Diversity",paths3$predictor)
paths3$predictor<-ifelse(paths3$predictor=="Yn_FDis4","Functional Diversity",paths3$predictor)
...
png(filename="/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/PathCoefficients_Rst_FDisEPSE.png", 
    type="cairo",
    units="in", 
    width=5 ,
    height=5, 
...
exdry<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXDRY_epse_fric_sem_coefs.csv",sep=",",header=TRUE)
exdry1<-filter(exdry,response=="lg2Rst12")
exdry1$PD_met<-"ePSE"
exdry1$FD_met<-"FRic"
exdry1$X<-NULL
...
wet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_epse_fric_sem_coefs_V1.csv",sep=",",header=TRUE)
wet1<-filter(wet,response=="lg2Rst12")
wet1$PD_met<-"ePSE"
wet1$FD_met<-"FRic"
wet1$X<-NULL
...
wet2<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_epse_fric_sem_coefs_V2.csv",sep=",",header=TRUE)
...
paths4<-rbind.data.frame(dry1,exdry1, wet11,exwet1)
...
paths4$predictor<-ifelse(paths4$predictor=="Yn_PCAcwm4trts","Fast-Slow (CWM)",paths4$predictor)
paths4$predictor<-ifelse(paths4$predictor=="Yn_ePSE","Phylogenetic Diversity",paths4$predictor)
paths4$predictor<-ifelse(paths4$predictor=="Yn_FRic4","Functional Diversity",paths4$predictor)
paths4$predictor<-ifelse(paths4$predictor=="Yn_FDis4","Functional Diversity",paths4$predictor)
...
png(filename="/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/PathCoefficients_Rst_FRicEPSE.png", 
    type="cairo",
    units="in", 
    width=5 ,
    height=5, 
...
exdry<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXDRY_emntd_fric_sem_coefs.csv",sep=",",header=TRUE)
exdry1<-filter(exdry,response=="lg2Rst12")
exdry1$PD_met<-"eMNTD"
exdry1$FD_met<-"FRic"
exdry1$X<-NULL
...
wet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_emntd_fric_sem_coefs_V1.csv",sep=",",header=TRUE)
wet1<-filter(wet,response=="lg2Rst12")
wet1$PD_met<-"eMNTD"
wet1$FD_met<-"FRic"
wet1$X<-NULL
...
wet2<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_WET_emntd_fric_sem_coefs_V2.csv",sep=",",header=TRUE)
wet22<-filter(wet2,response=="lg2Rst12")
wet22$PD_met<-"eMNTD"
wet22$FD_met<-"FRic"
wet22$X<-NULL
...
exwet<-read.delim("/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rst_EXWET_emntd_fric_sem_coefs.csv",sep=",",header=TRUE)
exwet1<-filter(exwet,response=="lg2Rst12")
exwet1$PD_met<-"eMNTD"
exwet1$FD_met<-"FRic"
exwet1$X<-NULL

paths5<-rbind.data.frame(dry1,exdry1, wet11,exwet1)
...
paths5$predictor<-ifelse(paths5$predictor=="Yn_PCAcwm4trts","Fast-Slow (CWM)",paths5$predictor)
paths5$predictor<-ifelse(paths5$predictor=="Yn_eMNTD","Phylogenetic Diversity",paths5$predictor)
paths5$predictor<-ifelse(paths5$predictor=="Yn_FRic4","Functional Diversity",paths5$predictor)
...
png(filename="/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/PathCoefficients_Rst_FRicEMNTD.png", 
    type="cairo",
    units="in", 
    width=5 ,
    height=5, 
