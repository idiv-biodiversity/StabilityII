...
rs_rll<-filter(rs_rl,Value=="Extreme_Wet")
...
#PD
a<-lme(Ye_eMNTD~lg2SppN,random=~1+lg2SppN|Site/PlotUnique2,correlation=x1,control=bb,data=rs_12)
a1<-lme(Ye_eMNTD~lg2SppN,random=~1|Site/PlotUnique2,correlation=x1,control=bb,data=rs_12)
AIC(a,a1)
...
Rsl_Wet_ModList=list(
  ...
  lme(lg2Rsl12~Ye_PCAcwm4trts+lg2SppN+Ye_eMNTD+Ye_FDis4,random=~1+lg2SppN|Site/PlotUnique2, correlation=x1,control=bb,data=rs_122)
...
wet_rsl_fdis_emntd_pc$Climate_Bin<-"Extreme Wet"
...
wet_rsl_fdis_emntd_modfit$Climate_Bin<-"Extreme Wet"
...
write.table(wet_rsl_fdis_emntd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_emntd_fdis_sem_coefs_NEW.csv",sep=",",row.names=F)
write.table(wet_rsl_fdis_emntd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_emntd_fdis_model_fits_NEW.csv",sep=",",row.names=F)
...
Rsl_Wet_ModList=list(
  ...
  lme(Ye_FDis4~lg2SppN,random=~1+lg2SppN|Site/PlotUnique2, correlation=x1,control=bb,data=rs_122),
  lme(lg2Rsl12~Ye_FDis4+Ye_PCAcwm4trts+lg2SppN,random=~1+lg2SppN|Site/PlotUnique2, correlation=x1,control=bb,data=rs_122)
...
sem.fit(Rsl_Wet_ModList,rs_122,corr.errors=c("Ye_eMPD~~Ye_FDis4","Ye_FDis4 ~~ Ye_PCAcwm4trts"," Ye_eMPD ~~ Ye_PCAcwm4trts"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))


# no further changes
wet_rsl_fdis_empd_pc<- sem.coefs(Rsl_Wet_ModList,rs_122,standardize="scale")
wet_rsl_fdis_empd_pc$Climate_Bin<-"Extreme Wet"

wet_rsl_fdis_empd_modfit<-sem.model.fits(Rsl_Wet_ModList)

wet_rsl_fdis_empd_modfit$ResponseVars<-c("Ye_eMPD","FDis4","Resilience")
wet_rsl_fdis_empd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,FDis4,lg2SppN")
wet_rsl_fdis_empd_modfit$Climate_Bin<-"Extreme Wet"


resids.df1<-partial.resid(lg2Rsl12~Ye_eMPD,Rsl_Wet_ModList,data=rs_12,
                          model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))

write.table(wet_rsl_fdis_empd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_empd_fdis_sem_coefs_V2_NEW.csv",sep=",",row.names=F)
write.table(wet_rsl_fdis_empd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_empd_fdis_model_fits_V2_NEW.csv",sep=",",row.names=F)
...
wet_rsl_fdis_epse_pc$Climate_Bin<-"Extreme Wet"

wet_rsl_fdis_epse_modfit<-sem.model.fits(Rsl_Wet_ModList)

wet_rsl_fdis_epse_modfit$ResponseVars<-c("Ye_ePSE","FDis4","Resilience")
wet_rsl_fdis_epse_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,ePSE,lg2SppN")
wet_rsl_fdis_epse_modfit$Climate_Bin<-"Extreme Wet"

sem.plot(Rst_Wet_ModList,rs_12,show.nonsig = FALSE,scaling=20)

resids.df1<-partial.resid(lg2Rsl12~Ye_FDis4,Rsl_Wet_ModList,data=rs_12,
                          model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))

write.table(wet_rsl_fdis_epse_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_epse_fdis_sem_coefs_V2_NEW.csv",sep=",",row.names=F)
write.table(wet_rsl_fdis_epse_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_epse_fdis_model_fits_V2_NEW.csv",sep=",",row.names=F)
...
sem.fit(Rsl_Wet_ModList,rs_122,corr.errors=c("Ye_eMNTD~~Ye_FRic4"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))
...
sem.coefs(Rsl_Wet_ModList,rs_122,standardize="scale")

wet_rsl_fric_emntd_pc<- sem.coefs(Rsl_Wet_ModList,rs_122,standardize="scale")
wet_rsl_fric_emntd_pc$Climate_Bin<-"Extreme Wet"

wet_rsl_fric_emntd_modfit<-sem.model.fits(Rsl_Wet_ModList)

wet_rsl_fric_emntd_modfit$ResponseVars<-c("eMNTD","FRic4","Resilience")
wet_rsl_fric_emntd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,eMNTD,FRic4,lg2SppN")
wet_rsl_fric_emntd_modfit$Climate_Bin<-"Extreme Wet"

sem.plot(Rst_Dry_ModList,rs_122,show.nonsig = FALSE,scaling=20)

resids.df1<-partial.resid(lg2Rsl12~Ye_FRic4,Rsl_Wet_ModList,data=rs_122,
                          model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))

write.table(wet_rsl_fric_emntd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_emntd_fric_sem_coefs.csv",sep=",",row.names=F)
write.table(wet_rsl_fric_emntd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_emntd_fric_model_fits.csv",sep=",",row.names=F)
...
sem.fit(Rsl_Wet_ModList,rs_122,corr.errors=c("Ye_eMPD~~Ye_FRic4","Ye_eMPD ~~ Ye_PCAcwm4trts"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))


# no further changes

wet_rsl_fric_empd_pc<- sem.coefs(Rsl_Wet_ModList,rs_122,standardize="scale")
wet_rsl_fric_empd_pc$Climate_Bin<-"Extreme Wet"

wet_rsl_fric_empd_modfit<-sem.model.fits(Rsl_Wet_ModList)
wet_rsl_fric_empd_modfit$ResponseVars<-c("Yn_eMPD","FRic4","Resilience")
wet_rsl_fric_empd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,Ye_eMPD,FRic4,lg2SppN")
wet_rsl_fric_empd_modfit$Climate_Bin<-"Extreme Wet"

sem.plot(Rsl_Wet_ModList,rs_122,show.nonsig = FALSE,scaling=20)

resids.df1<-partial.resid(lg2Rsl12~Ye_eMPD,Rsl_Wet_ModList,data=rs_122,
                          model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))

write.table(wet_rsl_fric_empd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_empd_fric_sem_coefs.csv",sep=",",row.names=F)
write.table(wet_rsl_fric_empd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_empd_fric_model_fits.csv",sep=",",row.names=F)
...
sem.fit(Rsl_Wet_ModList,rs_122,corr.errors=c("Ye_ePSE~~Ye_FRic4"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))

#Naive Model

sem.fit(Rsl_Wet_ModList,rs_122,corr.errors=c("Ye_ePSE~~Ye_FRic4","Ye_ePSE ~~ Ye_PCAcwm4trts"),conditional=T,
        model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))



wet_rsl_fric_epse_pc<- sem.coefs(Rsl_Wet_ModList,rs_122,standardize="scale")
wet_rsl_fric_epse_pc$Climate_Bin<-"Extreme Wet"

wet_rsl_fric_epse_modfit<-sem.model.fits(Rsl_Wet_ModList)
wet_rsl_fric_epse_modfit$ResponseVars<-c("Ye_ePSE","FRic4","Resilience")
wet_rsl_fric_epse_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,Ye_ePSE,lg2SppN")
wet_rsl_fric_epse_modfit$Climate_Bin<-"Extreme Wet"


resids.df1<-partial.resid(lg2Rsl12~Ye_ePSE,Rsl_Wet_ModList,data=rs_122,
                          model.control = list(lmeControl(msMaxIter=0,msVerbose = TRUE,opt="optim",maxIter=100,optimMEthod="L-BFGS-B")))

write.table(wet_rsl_fric_epse_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_epse_fric_sem_coefs.csv",sep=",",row.names=F)
write.table(wet_rsl_fric_epse_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_epse_fric_model_fits.csv",sep=",",row.names=F)
