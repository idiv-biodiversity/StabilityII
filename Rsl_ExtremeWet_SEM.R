...
Rsl_Wet_ModList=list(
  ...
  lme(lg2Rsl12~Ye_PCAcwm4trts+lg2SppN+Ye_eMNTD,random=~1+lg2SppN|Site/PlotUnique2, correlation=x1,control=bb,data=rs_12)
...
wet_rsl_fdis_emntd_modfit$PredVars<-c("lg2SppN","lg2SppN","F-S,eMNTD,lg2SppN")
...
write.table(wet_rsl_fdis_emntd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_emntd_fdis_sem_coefs_V2.csv",sep=",",row.names=F)
write.table(wet_rsl_fdis_emntd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_emntd_fdis_model_fits_V2.csv",sep=",",row.names=F)
...
write.table(wet_rsl_fdis_empd_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_empd_fdis_sem_coefs_V1.csv",sep=",",row.names=F)
write.table(wet_rsl_fdis_empd_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_empd_fdis_model_fits_V1.csv",sep=",",row.names=F)
...
write.table(wet_rsl_fdis_epse_pc,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_epse_fdis_sem_coefs_V2.csv",sep=",",row.names=F)
write.table(wet_rsl_fdis_epse_modfit,"/home/dylan/Dropbox/leipzigPhyTrt/StabilityII_data/Community_Level/Rsl_EXWET_epse_fdis_model_fits_V2.csv",sep=",",row.names=F)
